...
<main>
    ...
    try {
        ...
        $requete = "
        SELECT athlete.id_athlete, athlete.nom_athlete, athlete.prenom_athlete, epreuve.id_epreuve, epreuve.nom_epreuve, participer.resultat, pays.nom_pays
        FROM participer
        ...
        if ($statement->rowCount() > 0) {
            echo "<table>";
            echo "<tr><th class='color'>Nom de athlete</th><th class='color'>Prenom de athlete</th><th class='color'>Nationalité</th><th class='color'>Nom de l'epreuve</th></th><th class='color'>resultat</th></tr>";
